				...
				<div class="row">
					<div class="col-sm-4 col-sm-offset-1">
						<form class="form-horizontal" id="formlogin" method="post" role="form">
							<div class="form-group">
								<label for="inputUsuario">Usuario</label> <input type="text" name="usuario"
									class="form-control" id="inputUsuario" placeholder="Usuario"><br>
					...
					<div class="col-sm-6 col-sm-offset-1">
						<div class="panel-body">
							<img src="../../img/logotipo.png" class="img-responsive img-rounded" alt="Logotipo">
						</div>
					</div>
				</div>
				<div>
